...
public class AudioConfigurationScriptableObject : ScriptableObject, System.ICloneable
{ 
/*    [Range(0, 1f)]
    ...
    public object Clone()
    {
        AudioConfigurationScriptableObject config = CreateInstance<AudioConfigurationScriptableObject>();
