...
public class ShootConfiguraionScriptableObject : ScriptableObject,  System.ICloneable
{
    ...
    public object Clone()
    {
        ShootConfiguraionScriptableObject config = CreateInstance<ShootConfiguraionScriptableObject>();
